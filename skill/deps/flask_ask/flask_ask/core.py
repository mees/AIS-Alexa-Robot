...
import aniso8601
from flask import _app_ctx_stack, current_app, json
...
from .cache import set_stream, top_stream
...
class Ask(object):
    ...
    def __init__(self, app=None, route=None, blueprint=None, stream_cache=None, path="templates.yaml"):
        ...
        self._can_fullfill_intent_func = None
    ...
    def can_fullfill_intent(self, f):
        """Decorator maps a view function as the endpoint for an Alexa CanFulfillIntentRequest and starts the skill.
        ...
        Arguments:
            f {function} -- Launch view function
        """
        self._can_fullfill_intent_func = f
    ...
    def _flask_view_func(self, *args, **kwargs):
        ...
        elif request_type == "CanFulfillIntentRequest" and self._can_fullfill_intent_func:
            result = self._can_fullfill_intent_func(self.request.intent)
