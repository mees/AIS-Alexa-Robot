...
from aniso8601.timezone import build_utcoffset, UTCOffset
...
class TestCoreRoutines(unittest.TestCase):
    ...
    @patch(
        ...
        new=FakeRequest({"request": {"timestamp": 1234}, "session": {"application": {"applicationId": 1}}}),
    )
    ...
    def test_tries_parsing_on_valueerror(self):
        ...
        self.assertEqual(datetime(1978, 1, 11, 21, 31, 40).timetuple()[0:6], result.timetuple()[0:6])
